  ...
  return (
    <nav className="flex items-center justify-between bg-white px-4 py-2 ">
      ...
      <ul className="flex items-center justify-between gap-6 text-slate-900">
        <li className="cursor-pointer  rounded-full  px-6 py-2  hover:bg-sky-600">
          Home
        </li>
        <li className="cursor-pointer  rounded-full px-6 py-2  hover:bg-sky-600">
          Services
      ...
      <div>
        <li className="cursor-pointer flex gap-2 list-none rounded-full px-6 py-2  hover:bg-sky-600">
          <svg
            className="w-4"
            viewBox="0 0 15 15"
            version="1.1"
